...
- **Asset & Depreciation** (fixed assets, depreciation runs, disposals, movements, import, data quality, permissions): **`asset-module-manual-en.md`** / **`asset-module-manual-id.md`**.
