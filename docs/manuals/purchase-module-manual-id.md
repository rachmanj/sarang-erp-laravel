...
- **Sumber Data**: Biasanya dibuat dari kuantitas GRPO.
- **Akuntansi**: Menggunakan akun perantara AP UnInvoice; pindah ke AP saat dibayar.
...
- Invoice yang sudah Approved muncul di daftar alokasi Purchase Payment.
