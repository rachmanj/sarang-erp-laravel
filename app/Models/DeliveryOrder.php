...
class DeliveryOrder extends Model
{
    ...
    public function businessPartnerAddress(): BelongsTo
    {
        return $this->belongsTo(BusinessPartnerAddress::class, 'business_partner_address_id');
    }
    ...
    {
        return $this->belongsToMany(\App\Models\Accounting\SalesInvoice::class, 'delivery_order_sales_invoice', 'delivery_order_id', 'sales_invoice_id')
            ->withTimestamps();
    }
