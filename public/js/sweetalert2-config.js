...
if (typeof Swal !== 'undefined') {
    ...
    window.confirmDelete = async function(title = 'Are you sure?', text = "You won't be able to revert this!", confirmText = 'Yes, delete it!') {
    ...
    window.showSuccess = function(title = 'Success!', text = 'Operation completed successfully', timer = 2000) {
        Swal.fire({
            icon: 'success',
            title: title,
            text: text,
    ...
    window.showError = function(title = 'Error!', text = 'An error occurred', html = null) {
        Swal.fire({
            icon: 'error',
            title: title,
            text: html ? null : text,
