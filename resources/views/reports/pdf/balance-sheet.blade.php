<div style="font-family: DejaVu Sans, Helvetica, Arial, sans-serif; color: #1a1a1a;">
    <div style="border-bottom: 2px solid #1e3a5f; padding-bottom: 8px; margin-bottom: 14px;">
        ...
        <div style="font-size: 11px; text-transform: uppercase; letter-spacing: 1px; color: #555; margin-top: 2px;">Statement
            of Financial Position</div>
        <div style="font-size: 10px; color: #666; margin-top: 6px;">As of {{ $as_of }} · Posted:
        ...
        <table width="100%" cellspacing="0" cellpadding="5" border="1" style="border-collapse: collapse; margin-bottom: 12px; font-size: 9px;">
            ...
            <tfoot>
                <tr style="background: #e8eef5; font-weight: bold;">
                    <th align="left" colspan="2">Total {{ $section['label'] }}</th>
    ...
    <table width="100%" cellspacing="0" cellpadding="5" border="1" style="border-collapse: collapse; font-size: 9px;">
        <tr>
            <th align="left" width="70%">Total assets</th>
        ...
        <tr>
            <th align="left">Total equity / net assets</th>
            <td align="right">{{ number_format($totals['equity'], 2) }}</td>
        </tr>
        <tr>
            <th align="left">Difference (A − L − E)</th>
            <td align="right">{{ number_format($totals['difference'], 2) }}</td>
        </tr>
        <tr>
            <th align="left">Unclosed P&amp;L (income &amp; expense, cumulative)</th>
            <td align="right">{{ number_format($totals['unclosed_pnl_cumulative'], 2) }}</td>
        </tr>
        <tr>
            <th align="left">Check (difference − unclosed P&amp;L)</th>
            <td align="right">{{ number_format($totals['difference_vs_unclosed_pnl'], 2) }}</td>
        </tr>
    </table>
</div>
