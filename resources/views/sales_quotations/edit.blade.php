...
@section('title_page')
    Edit Sales Quotation - {{ $quotation->quotation_no }}
@endsection
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card card-primary card-outline">
                        ...
                        <form method="post" action="{{ route('sales-quotations.update', $quotation->id) }}" id="quotation-form">
                            @csrf
                            @method('PATCH')
                                            ...
                                            <div class="col-sm-9">
                                                <div class="input-group input-group-sm">
                                                    ...
                                                    <input type="date" name="date"
                                                        value="{{ old('date', $quotation->date->format('Y-m-d')) }}"
                                        ...
                                        <div class="form-group row mb-2">
                                            ...
                                            <div class="col-sm-9">
                                                <div class="input-group input-group-sm">
                                                    ...
                                                    <input type="text" name="quotation_no" value="{{ $quotation->quotation_no }}"
                                                ...
                                                <select name="company_entity_id" id="company_entity_id"
                                                    ...
                                                    @foreach ($entities as $entity)
                                                        <option value="{{ $entity->id }}"
                                                            {{ old('company_entity_id', $quotation->company_entity_id) == $entity->id ? 'selected' : '' }}>
                                            ...
                                            <div class="col-sm-9">
                                                <div class="input-group input-group-sm">
                                                    ...
                                                    <input type="date" name="valid_until_date"
                                                        value="{{ old('valid_until_date', $quotation->valid_until_date ? $quotation->valid_until_date->format('Y-m-d') : now()->addDays(30)->toDateString()) }}"
                                                        class="form-control" required>
                                                </div>
                                        ...
                                        <div class="form-group row mb-2">
                                            ...
                                            <div class="col-sm-9">
                                                <select name="order_type" class="form-control form-control-sm select2bs4"
                                                    ...
                                                    <option value="item"
                                                        {{ old('order_type', $quotation->order_type) == 'item' ? 'selected' : '' }}>
                                                        Item (Physical Inventory)
                                                    </option>
                                                    <option value="service"
                                                        {{ old('order_type', $quotation->order_type) == 'service' ? 'selected' : '' }}>
                                            ...
                                            <div class="col-sm-9">
                                                <select name="warehouse_id" class="form-control form-control-sm select2bs4">
                                                    ...
                                                    @foreach ($warehouses as $w)
                                                        <option value="{{ $w->id }}"
                                                            {{ old('warehouse_id', $quotation->warehouse_id) == $w->id ? 'selected' : '' }}>
                                                            {{ $w->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="form-group row mb-2">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" name="description"
                                                    ...
                                                    class="form-control form-control-sm" placeholder="Quotation description">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <div class="col-sm-9">
                                                <div class="input-group input-group-sm">
                                                    <input type="number" name="exchange_rate" id="exchange_rate"
                                                        ...
                                                        value="{{ old('exchange_rate', $quotation->exchange_rate) }}">
                                        ...
                                        <div class="form-group row mb-2">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="number" step="0.01" min="0" max="100" name="discount_percentage" id="discount_percentage"
                                                    ...
                                                    class="form-control form-control-sm" placeholder="Header discount percentage">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group row mb-2">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="number" step="0.01" min="0" name="discount_amount" id="discount_amount"
                                                    value="{{ old('discount_amount', $quotation->discount_amount) }}"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <textarea name="terms_conditions" class="form-control form-control-sm" rows="3"
                                                placeholder="Enter terms and conditions...">{{ old('terms_conditions', $quotation->terms_conditions) }}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <textarea name="notes" class="form-control form-control-sm" rows="3"
                                                placeholder="Additional notes...">{{ old('notes', $quotation->notes) }}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
@push('scripts')
    <script>
        ...
        window.existingLines = @json($quotation->lines ?? []);
        ...
        $(document).ready(function() {
            ...
            // Populate existing lines if editing
            if (window.existingLines && window.existingLines.length > 0) {
                window.existingLines.forEach(function(line) {
                    const lineData = {
                        item_id: line.inventory_item_id || line.account_id,
                ...
                // Add first line if no existing lines
            ...
            $(document).on('input', '.line-discount-percentage', function() {
                ...
                const lineAmount = parseFloat(row.find('.line-amount').text().replace(/\./g, '').replace(',', '.') || 0);
