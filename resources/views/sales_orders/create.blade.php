                                            ...
                                            <div class="col-sm-9">
                                                <div class="input-group input-group-sm">
                                                    ...
                                                    <div class="input-group-append">
                                                        <button type="button" class="btn btn-outline-secondary" id="preview-so-number" title="Preview next number (does not consume)">
                                        ...
                                        <div class="form-group row mb-2">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="number" step="0.01" min="0" max="100"
                                                    ...
                                                    placeholder="Header discount on line total">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
...
@push('scripts')
    <script>
        ...
        $(document).ready(function() {
            ...
            // Preview button - show next SO number without consuming
            $('#preview-so-number').on('click', function() {
                updateDocumentNumber();
            });
                ...
                $.get('{{ route('unit-of-measures.api.item-units') }}', { item_id: itemId })
                    .done(function(units) {
                        ...
                        units.forEach(function(unit) {
                            ...
                            $unitSelect.append(`<option value="${unit.id}" ${selected}>${unit.display_name}</option>`);
                        });
                    })
                    .fail(function() {
