                ...
                <div class="col-12">
                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-header">
                            ...
                            <a href="{{ route('warehouses.index') }}" class="btn btn-sm btn-secondary float-right">
                                <i class="fas fa-arrow-left"></i> Back to Warehouses
                            </a>
                        </div>
                        <form method="post" action="{{ route('warehouses.store') }}" id="warehouse-form">
                            @csrf
                                        ...
                                        <div class="form-group row mb-2">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control form-control-sm" name="code"
                                                    value="{{ old('code') }}" placeholder="Enter warehouse code" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group row mb-2">
                                            ...
                                            <div class="col-sm-10">
                                                <textarea class="form-control form-control-sm" name="address" rows="2" placeholder="Enter warehouse address">{{ old('address') }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
