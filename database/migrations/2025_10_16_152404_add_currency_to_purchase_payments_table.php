...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('purchase_payments', function (Blueprint $table) {
            ...
            $table->decimal('exchange_gain_loss', 15, 2)->default(0)->after('total_amount_foreign');
    ...
    public function down(): void
    {
        Schema::table('purchase_payments', function (Blueprint $table) {
            ...
            $table->dropColumn(['currency_id', 'exchange_rate', 'total_amount_foreign', 'exchange_gain_loss']);
        });
    }
};
